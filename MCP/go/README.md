# Open-Meteo APIs MCP Server

This MCP (Model Content Protocol) server provides access to Open-Meteo APIs API functionality through HTTP, HTTPS, and STDIO transport modes.
